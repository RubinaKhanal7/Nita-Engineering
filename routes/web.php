...
Route::middleware([
    ...
    Route::as('admin.')->prefix('admin')->group( function () {
        ...
        Route::put('/user/password', function (Request $request) {
            $updateUserPassword = app(\App\Actions\Fortify\UpdateUserPassword::class);
        ...
        })->middleware(['auth'])->name('user.password.update');
        ...
        Route::as('coverimage.')->prefix('coverimage')->group(function (){
         ...
         Route::as('vacancies.')->prefix('vacancies')->group(function () {
           ...
           Route::as('applications.')->prefix('applications')->group(function (){
            ...
            Route::delete('admin/applications/{id}', [ApplicationController::class, 'destroy'])->name('destroy');
            Route::patch('/admin/applications/{id}/update-status', [ApplicationController::class, 'updateStatus'])->name('update-status');
...
Route::get('/gallery/{gallery}', [SingleController::class, 'single_image'])->name('gallery.show');
