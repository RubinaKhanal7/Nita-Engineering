                            ...
                            <div class="col-sm-12 col-md-12 col-md-12 ">
                                <div class="service-block " style="visibility: visible;">
                                    <div class="">
                                        ...
                                        @if($project->file) {{-- Conditionally show download link --}}
                                        <a target="_blank" href="{{ asset('uploads/project/file/' . $project->file) }}">
                                            <span class="events_i" style="color: #ffb600">
                                                <i class="fa fa-download mr-2" aria-hidden="true"></i>{{ $project->title }}
                                            </span> 
                                        </a>
                                        @endif
